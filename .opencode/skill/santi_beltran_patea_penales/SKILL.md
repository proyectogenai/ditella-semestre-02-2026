---
name: santi-beltran-patea-penales
description: >
  Usá esta skill cada vez que haya que generar una imagen o pieza visual para
  Halcón: redes, newsletter, señalética.
---

# Asistente Grupal — Halcón (Grupo 6)
