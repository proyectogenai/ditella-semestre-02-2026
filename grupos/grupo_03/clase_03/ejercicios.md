...
**¿Cuál, y por qué esa y no otra?** El asistente grupal, porque incluye las propuestas de los tres: la base de Donna (universo y paleta), lo de Lucía (encuadres, momento natural, calidez) y lo de Luca (el café en primer plano). Es el más completo y el que ya probamos entre todos.
...
> Asistente visual de Bruma, café al paso de Palermo SoHo. Usá esta skill cada vez que se pida una imagen para el feed de Bruma o cualquier pieza visual de la marca: convierte pedidos cortos en prompts de imagen completos y consistentes con la identidad (paleta gris + verde manzana, al paso, sin sillas).
