...
## 1. Carnaval ✅ (ya aprobada — dejo el prompt igual por si la reprobás)
...
07 — COMPOSITION
EXTREMELY wide, zoomed-out panoramic composition, built for a full A3 horizontal double-page spread: pull the camera back MUCH further than feels natural — closer to a high, distant establishing shot where the whole location and its surroundings fit in frame at once. Activity extending toward and past all four borders. Clear foreground, middle ground and background. Avoid placing Lourdes exactly at the center. Landscape format, 1414x1000px.
...
MANDATORY FINAL CHECK: Lourdes (described in section 04 above, and shown in the attached reference image) MUST physically appear somewhere in this scene. Before finishing, verify you actually placed her — a bob-haired woman in a red crop top with a long skirt, wide belt, ankle boots and a heart-charm purse — in the crowd, following the placement rules from section 06.
```

---

## 2. Fiesta en un barco
...
SPECIFIC ACTIVITIES: a large bonfire with a driftwood sculpture centerpiece nearby; a DJ booth with speakers near the shore; people dancing under a limbo bar, one person mid-fall as the bar goes too low; a food stand and a separate drinks stand nearby, someone handing out fresh coconuts, one coconut rolling away after being dropped; a stack of surfboards leaning against a lifeguard tower in the background; a couple sharing a hammock strung between two palm trees; kids building a sandcastle near the shoreline; someone photographing the sunrise with an old film camera
...
SPECIFIC ACTIVITIES: a massive illuminated neon heart-shaped sign as the visual centerpiece of the terrace; a DJ booth with speakers and colorful lighting rigs; a bartender juggling bottles behind an elaborate cocktail bar, one bottle mid-air about to be dropped; people dancing packed together near the DJ; someone leaning far over the railing taking a photo of the skyline; a group toasting with sparklers; someone tripping over a string of fairy lights, pulling part of the display down, a small dog tangled in the lights
...
## 6. Festival de música al aire libre
...
SPECIFIC ACTIVITIES: a massive main stage with a band performing, oversized speaker towers and a giant decorative art sculpture beside the stage as the visual centerpiece; a rest area with people lounging on blankets and camping chairs; a row of food stalls serving different snacks, one stall's tray tipping over mid-spill; someone crowd-surfing above the audience; a group dancing on someone's shoulders; a tent partially collapsing nearby
...
## 7. Celebración en el Obelisco de Buenos Aires
...
## 8. Garden party de tarde ✅ (ya aprobada — dejo el prompt igual por si la reprobás)
...
SPECIFIC ACTIVITIES: a massive, elaborate floral archway as the visual centerpiece of the lawn; guests seated at scattered tables having tea and pastries; a croquet ball that just knocked over a stack of teacups mid-crash; a cricket fielder diving dramatically for a catch; a small band playing under a gazebo; a dog stealing a pastry and being chased; children racing through a hedge maze
